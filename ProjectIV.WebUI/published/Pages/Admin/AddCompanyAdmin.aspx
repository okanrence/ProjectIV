<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCompanyAdmin.aspx.cs" Inherits="ProjectIV.WebUI.Admin.AddCompanyAdmin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h4>Add New Company Administrator</h4>
    <hr />
    <div class="container">
          <div class="row">
             <div class="col-md-4 form-group">
                ...
                <asp:DropDownList runat="server" ID="ddlCompany" CssClass="form-control">
                    ...
                    <asp:ListItem Value="1">Company A</asp:ListItem>
                    <asp:ListItem Value="2">Company B</asp:ListItem>
                </asp:DropDownList>
